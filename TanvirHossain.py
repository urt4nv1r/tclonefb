...
def login():
	...
	try:
		...
		print "\033[1;95m      тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАв\033[1;96mTanvirHossain\033[1;95mтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:tanvir_hossain
	print logo
